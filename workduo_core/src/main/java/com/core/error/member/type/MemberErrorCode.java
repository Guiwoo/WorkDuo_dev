package com.core.error.member.type;
...
public enum MemberErrorCode {
    ...
    // 멤버 피드 에러
    MEMBER_CONTENT_AUTHORIZATION(HttpStatus.FORBIDDEN,"❌ 권한 이 없습니다."),
    ...
    //일정 에러
    MEMBER_CALENDAR_DOES_NOT_EXIST(HttpStatus.BAD_REQUEST,"❌ 일정 이 없습니다."),;
