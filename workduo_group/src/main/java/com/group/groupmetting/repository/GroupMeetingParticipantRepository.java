package com.group.groupmetting.repository;
...
public interface GroupMeetingParticipantRepository extends JpaRepository<GroupMeetingParticipant, Long> {
    ...
    void deleteAllByGroup(@Param("com/group") Group group);
    @Modifying
    ...
    void deleteAllByGroupAndGroupMeeting(
            @Param("com/group") Group group, @Param("groupMeeting") GroupMeeting groupMeeting);
