package com.group.group.controller;
...
public class GroupController {
    ...
    public ApiResult<?> detailGroup(
        ...
        return ApiUtils.success(groupService.groupDetail(groupId));
    }
    ...
    public ApiResult<?> groupList(
        ...
        return ApiUtils.success(groupService.groupList(pageable, condition));
    }
    ...
    public ApiResult<?> groupThumbnailUpdate(
        ...
        return ApiUtils.success(groupService.groupThumbnailUpdate(groupId, multipartFiles));
    }
    ...
    public ApiResult<?> groupUpdate(
        ...
        return ApiUtils.success(groupService.groupUpdate(groupId, request));
    }
}
